...
namespace TinyQuest.Data.Request {
	...
	{
		public override void StartBattle(MonoBehaviour monoBehaviour, System.Action<CombatUnitGroup[], int[][]> callback) {
			...
			callback(data.combatUnitGroups, data.standByUnits);
		}
	}
}
