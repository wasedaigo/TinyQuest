...
describe("Animation", function() {
    ...
    describe("TestInterval", function() {
        ...
        it("AnimationTest1", function() {
            ...
            var interval = enchant.animation.CreateAnimation(root, enchant.loader.get("Smoke01"));
        ...
        it("AnimationTest2", function() {
        	var root = new enchant.canvas.Node();
            var interval = enchant.animation.CreateAnimation(root, enchant.loader.get("SmokeRing"));
